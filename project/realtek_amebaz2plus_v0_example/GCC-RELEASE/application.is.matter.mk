...
AMEBAZ2_BOOTLOADERDIR = $(AMEBAZ2_BSPDIR)/image_z2plus
...
SRC_C += ../../../component/common/bluetooth/realtek/sdk/board/amebaz2/src/hci/bt_mp_patch_z2plus.c
SRC_C += ../../../component/common/bluetooth/realtek/sdk/board/amebaz2/src/hci/bt_normal_patch_z2plus.c
...
CFLAGS += -DCONFIG_PLATFORM_Z2PLUS
CFLAGS += -DV8M_STKOVF
...
all: LIBFLAGS += -Wl,--start-group -L../../../component/soc/realtek/8710c/misc/bsp/lib/common/GCC -l_soc_is -l_wlan_z2plus -Wl,--end-group
mp: LIBFLAGS += -Wl,--start-group -L../../../component/soc/realtek/8710c/misc/bsp/lib/common/GCC -l_soc_is -l_wlan_mp_z2plus -Wl,--end-group
