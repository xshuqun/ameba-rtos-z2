...
#if defined(MBEDTLS_VERSION_NUMBER) && (MBEDTLS_VERSION_NUMBER>=0x03010000)
	if ((ret = mbedtls_pk_parse_key(&server_pk, (const unsigned char *) mbedtls_test_srv_key, mbedtls_test_srv_key_len, NULL, 0, rtw_get_random_bytes_f_rng,
									(void *)1)) != 0) {
#else
...
#endif //#if defined(CONFIG_EXAMPLE_SSL_SERVER) && CONFIG_EXAMPLE_SSL_SERVER
