...
void ble_matter_adapter_app_le_profile_init(void)
{
	...
	/* Add Client Module */
	client_init(1);
	ble_matter_adapter_gcs_client_id = gcs_add_client(ble_matter_adapter_gcs_client_callback, BLE_MATTER_ADAPTER_APP_MAX_LINKS,
									   BLE_MATTER_ADAPTER_APP_MAX_DISCOV_TABLE_NUM);
